        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="widget-area-2 proclinic-box-shadow">
                    <h3 class="widget-title">Add Frontend Top Bar</h3>
                    <form action="{{route('frontend_top_bar.store')}}" method="POST">
                        @csrf
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" name="item" value="{{old('item')}}" placeholder="Item" id="item">
                                @error('item')
                                <small class="text-danger">{{$message}}</small>
                                @enderror
                            </div>
