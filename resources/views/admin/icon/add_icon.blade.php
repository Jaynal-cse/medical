...
<div class="col-md-6">
       ...
       <li class="breadcrumb-item"><a href="">Frontend</a></li>
        <li class="breadcrumb-item active">Add Icon & Title</li>
</div>
@endsection
        ...
        <div class="card-body">
            ...
            @csrf
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" placeholder="Frontend Title" name="frontend_title">
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" placeholder="Dashboard Title" name="dashboard_title">
                    </div>
