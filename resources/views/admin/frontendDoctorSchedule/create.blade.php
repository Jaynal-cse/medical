...
<div class="col-md-6">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{route('frontend_doctor_schedule.index')}}">Doctor Schedule Heading</a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="widget-area-2 proclinic-box-shadow">
                    <h3 class="widget-title">Add Doctor Schedule Heading</h3>
                    <form action="{{route('frontend_doctor_schedule.store')}}" method="POST">
                        @csrf
                        <div class="form-row">
