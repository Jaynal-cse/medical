        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="widget-area-2 proclinic-box-shadow">
                    <h3 class="widget-title">Add Footer Heading Item</h3>
                    <form action="{{route('footer_heading_item.store')}}" method="POST">
                        @csrf
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                <label for="heading_item">heading_item</label>
                                <input type="text" class="form-control" name="heading_item" value="{{old('heading_item')}}" placeholder="Heading Item" id="heading_item">
                                @error('heading_item')
                                <small class="text-danger">{{$message}}</small>
                                @enderror
                            </div>
