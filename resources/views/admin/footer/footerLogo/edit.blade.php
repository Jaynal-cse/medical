        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="widget-area-2 proclinic-box-shadow">
                    ...
                    <form action="{{route('footer_logo.update',$footerLogo->id)}}" method="POST" enctype="multipart/form-data">
                        {{method_field('PUT')}}
                        @csrf
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="file" name="logo" class="form-control" value="{{$footerLogo->logo}}" id="file">
                                @error('logo')
