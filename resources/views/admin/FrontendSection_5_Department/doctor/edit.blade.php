        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="widget-area-2 proclinic-box-shadow">
                    <h3 class="widget-title">Edit Frontend Doctor</h3>
                    <form action="{{route('frontend_doctor.update', $frontendDoctor->id)}}" method="POST">
                    {{method_field('PUT')}}
                        @csrf
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" name="doctor_name" value="{{$frontendDoctor->doctor_name}}" placeholder="Doctor Name" id="doctor_name">
                                @error('doctor_name')
                                <small class="text-danger">{{$message}}</small>
                                @enderror
                            </div>
