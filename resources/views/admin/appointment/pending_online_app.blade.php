...
<div class="col-md-6">
       ...
       <li class="breadcrumb-item"><a href="">Appointment</a></li>
        <li class="breadcrumb-item active">Pending Online Appointments</li>
</div>
@endsection
        ...
        <div class="col-md-12 pt-3">
            <div class="card">
                    <div class="card-header">
                        <h6><strong>Pendings Online Appointment Information</strong></h6>
                    </div>
                    <div class="card-body">
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{url('online_appointment_confirm')}}/{{$app->id}}"type="submit" title="Confirm" name="button" class="btn btn-success mt-0 mb-0"><span class="ti-check-box"></span></a>
                                            <a href="{{url('online_appointment_cancel')}}/{{$app->id}}"type="submit" title="Cancel" name="button" class="btn btn-warning mt-0 mb-0"><span class="ti-close"></span></a>
