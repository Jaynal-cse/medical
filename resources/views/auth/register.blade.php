  				...
  				<div class="container-fluid">
  					...
  					<div class="row">
  							...
  							<div class="account-content">
  								<div class="row align-items-center justify-content-center">
  									<div class="col-md-7 col-lg-6 login-left">
  										<img src="{{asset('login_assets/img/login-banner.png')}}" class="img-fluid" alt="Doccure Register">
  									</div>
  									<div class="col-md-12 col-lg-6 login-right">
  										<div class="login-header">
  											<h3>Patient Register <a href="{{url('DoctorRegister')}}">Are you a Doctor?</a></h3>
  										</div>
                        ...
                        @csrf
                          ...
                          <input id="status" type="hidden" class="form-control floating @error('status') is-invalid @enderror" name="status" value="Patient" required autocomplete="status" autofocus>
